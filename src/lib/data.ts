import type { HeroSlide, Category, Product, SiteConfig } from "@/types";
...
export const featuredProducts: Product[] = [
  {
    ...
    price: 450,
    images: [
      "/images/urunler/urun-1a.jpg",
      "/images/urunler/urun-1b.jpg",
    ],
    category: "ÇİÇEK",
    categorySlug: "cicek",
    isBestseller: true,
  },
  {
    ...
    slug: "pembe-sakayik-buketi",
    price: 550,
    images: [
      "/images/urunler/urun-2a.jpg",
      "/images/urunler/urun-2b.jpg",
    ],
    category: "ÇİÇEK",
    categorySlug: "cicek",
    isNew: true,
  ...
  {
    id: "p4",
    name: "Kutu Kırmızı Güller",
    slug: "kutu-kirmizi-guller",
    price: 650,
    salePrice: 550,
    images: [
      "/images/urunler/urun-4a.jpg",
      "/images/urunler/urun-4b.jpg",
    ],
    category: "HEDİYE KUTUSU",
    categorySlug: "hediye-kutusu",
    isBestseller: true,
  },
  {
    id: "p5",
    name: "Lila Lale Buketi",
    slug: "lila-lale-buketi",
    price: 320,
    images: [
      "/images/urunler/urun-5a.jpg",
      "/images/urunler/urun-2b.jpg",
    ],
    category: "ÇİÇEK",
    categorySlug: "cicek",
  ...
  {
    id: "p6",
    name: "Çiçek & Çikolata Seti",
    slug: "cicek-cikolata-seti",
    price: 580,
    images: [
      "/images/urunler/urun-6a.jpg",
      "/images/urunler/urun-6b.jpg",
    ],
    category: "ÇİKOLATA",
  ...
  },
  {
    ...
    price: 420,
    images: [
      "/images/urunler/urun-7a.jpg",
      "/images/urunler/urun-7b.jpg",
    ],
    category: "ORKİDE",
    categorySlug: "orkide",
    isBestseller: true,
  ...
  {
    id: "p8",
    name: "Beyaz Gelin Buketi",
    slug: "beyaz-gelin-buketi",
    price: 750,
    salePrice: 650,
    images: [
      "/images/urunler/urun-8a.jpg",
      "/images/urunler/urun-8b.jpg",
    ],
    category: "KOLEKSİYON",
    categorySlug: "koleksiyonlar",
    isNew: true,
  },
];
...
export const spotlightTabs = [
  {
    ...
    products: featuredProducts.filter((p) => p.isBestseller || p.id === "p5"),
  },
  {
    label: "Yeni Gelenler",
    products: featuredProducts.filter((p) => p.isNew || p.id === "p3"),
  },
  {
    label: "Tüm Ürünler",
