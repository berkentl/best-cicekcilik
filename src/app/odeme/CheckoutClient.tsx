                    ...
                    {form.invoiceType === "bireysel" ? (
                      <div>
                        <label className={labelClass}>
                          TC Kimlik No <span className="normal-case font-normal text-[#a09890]">(Zorunlu Değil)</span>
                        </label>
                        <input type="text" inputMode="numeric" placeholder="11 haneli TC Kimlik No"
