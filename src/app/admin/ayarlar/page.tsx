...
export default function AdminAyarlarPage() {
  ...
  const [email, setEmail] = useState("durucicekorganizasyon@gmail.com");
  const [address, setAddress] = useState("Fulya, 19 Mayis, Aytekin Kotil Cd. No: 18H, 34360 Sisli/Istanbul");
