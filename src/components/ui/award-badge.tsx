...
export function BestsellerBadge() {
  ...
  const overlayItems = [
    { deg: 0,  color: "hsl(358,100%,62%)" },
    { deg: 10, color: "hsl(30,100%,50%)" },
    { deg: 20, color: "hsl(60,100%,50%)" },
    { deg: 30, color: "hsl(96,100%,50%)" },
    { deg: 40, color: "hsl(233,85%,47%)" },
    { deg: 50, color: "hsl(271,85%,47%)" },
    { deg: 60, color: "hsl(300,20%,35%)" },
    { deg: 70, color: "transparent" },
    { deg: 80, color: "transparent" },
    { deg: 90, color: "white" },
  ];
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 54" className="w-full h-auto">
          ...
          <g style={{ mixBlendMode: "overlay" }} mask="url(#badgeMask)">
            {overlayItems.map((item, i) => (
              <g key={i} style={{
                transform: `rotate(${firstOverlayPosition + item.deg}deg)`,
                transformOrigin: "center center",
