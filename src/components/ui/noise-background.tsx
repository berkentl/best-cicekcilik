...
export const NoiseBackground = ({
  ...
  return (
    ...
    >
      ...
      <GradientLayer springX={springX} springY={springY} gradientColor={gradientColors[1]} opacity={0.35} multiplier={0.7} />
      <GradientLayer springX={springX} springY={springY} gradientColor={gradientColors[2] || gradientColors[0]} opacity={0.3} multiplier={1.2} />

      <motion.div
        className="absolute inset-x-0 top-0 h-[2px] opacity-70 blur-[1px]"
        style={{
