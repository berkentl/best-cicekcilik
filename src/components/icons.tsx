...
export function PhoneIcon({ className, size = 18 }: IconProps) {
  return (
    <svg
      ...
      className={cn(className)}
    >
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.42 2 2 0 0 1 3.58 1h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 8.96a16 16 0 0 0 6.29 6.29l1.12-.91a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
    </svg>
  );
}
...
export function EyeOffIcon({ className, size = 18 }: IconProps) {
  return (
    <svg
      ...
      className={cn(className)}
    >
      <path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a18.6 18.6 0 0 1 4.22-5.06M9.9 4.24A10.4 10.4 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24" />
...
export function LogoIcon({ className }: { className?: string }) {
  return (
    <span
      className={cn(
        "font-heading font-semibold tracking-wide text-[#1d3435] whitespace-nowrap text-[15px] sm:text-xl",
        className
      )}
    >
      Best Çiçekçilik
